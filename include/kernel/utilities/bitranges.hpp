 ...
 */
[[nodiscard]] bool get_flag(uint32_t value, size_t offset);
 ...
 */
[[nodiscard]] uint32_t set_flag(uint32_t value, size_t offset);
 ...
 * @return The value after the change.
 */
[[nodiscard]] uint32_t clear_flag(uint32_t value, size_t offset);
 ...
 */
[[nodiscard]] uint32_t get_field(uint32_t value, size_t msb, size_t lsb);
 ...
 * @return The value after the change.
 */
[[nodiscard]] uint32_t set_field(uint32_t value, size_t msb, size_t lsb,
